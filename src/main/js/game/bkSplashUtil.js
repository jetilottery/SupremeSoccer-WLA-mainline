...
function(PIXI){
    ...
    function addCanvas(width, height, container){
        ...
        pixiRenderer.view.id = 'changeBK';
        pixiRenderer.view.style.opacity = 1;
        pixiRenderer.view.style.backgroundSize = '100% 100%';
        pixiRenderer.view.style.backgroundPosition = 'center';
        pixiRenderer.view.style.backgroundRepeat = 'no-repeat';
